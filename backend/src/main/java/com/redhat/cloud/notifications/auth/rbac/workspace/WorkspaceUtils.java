...
public class WorkspaceUtils {
    ...
    /**
     * The user facing error we will return which just gives enough details.
     */
    protected static final String ERROR_USER_FACING = "Unable to get the default workspace";
    ...
    public UUID getDefaultWorkspaceId(final String orgId) {
        ...
        if (workspacePage.getMeta().getCount() > 1) {
            ...
            throw new IllegalStateException(ERROR_USER_FACING);
        }
