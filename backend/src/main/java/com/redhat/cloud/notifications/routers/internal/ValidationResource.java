...
import com.redhat.cloud.notifications.routers.internal.models.MessageErrorValidationResponse;
...
public class ValidationResource {
    ...
    @APIResponses({
            @APIResponse(
                    content = @Content(
                            ...
                            schema = @Schema(
                                    implementation = MessageErrorValidationResponse.class,
                                    required = true
                            )
                    ),
                    responseCode = "400"
    ...
    public Response validateMessage(String action) {
        try {
            ...
            MessageErrorValidationResponse responseMessage = new MessageErrorValidationResponse();
