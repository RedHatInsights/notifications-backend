...
public class EndpointResource extends EndpointResourceCommon {
    ...
    @Authorization(legacyRBACRole = RBAC_WRITE_INTEGRATIONS_ENDPOINTS, workspacePermissions = {WorkspacePermission.INTEGRATIONS_CREATE})
    ...
    @Transactional
    @Authorization(legacyRBACRole = ConsoleIdentityProvider.RBAC_WRITE_NOTIFICATIONS, workspacePermissions = BEHAVIOR_GROUPS_EDIT)
