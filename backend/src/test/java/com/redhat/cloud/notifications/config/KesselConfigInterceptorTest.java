...
public class KesselConfigInterceptorTest {
    ...
    private static Stream<Arguments> testCases() {
        return Stream.of(
            ...
            Arguments.of("inventory-api.target-url", "http://kessel-inventory-api.url.test:8000", "kessel-inventory-api.url.test:9081"),
            Arguments.of("inventory-api.target-url", "https://kessel-inventory-api-secure.url.test:8000", "kessel-inventory-api-secure.url.test:9081"),
