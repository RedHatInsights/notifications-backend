...
public class TestLifecycleManager implements QuarkusTestResourceLifecycleManager {
    ...
    void setupMockEngine(Map<String, String> props) {
        ...
        /*
         * The two following lines no longer work with Quarkus 2.4, most probably because of a Quarkus bug.
         * This requires further investigation. In the meantime, the new properties below can be used as a workaround.
         */
