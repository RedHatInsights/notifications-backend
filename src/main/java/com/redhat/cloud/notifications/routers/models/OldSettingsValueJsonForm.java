...
public class OldSettingsValueJsonForm {
    ...
    public static List<OldSettingsValueJsonForm> fromSettingsValue(SettingsValues values) {
        ArrayList<OldSettingsValueJsonForm> forms = new ArrayList<>();
