...
- Description: Connector responsible for the delivery of notifications to Pager Duty.
- Outage impact: moderate - notifications might be delayed or require a replay depending on the outage cause.
...
- Outage impact: critical - all notifications channel might be interrupted.
