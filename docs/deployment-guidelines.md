...
- Base image digest updates (`ubi9/openjdk-21-runtime` and friends) are handled by Renovate, not a dedicated workflow; see `renovate.jsonc` for the automerge rule.
