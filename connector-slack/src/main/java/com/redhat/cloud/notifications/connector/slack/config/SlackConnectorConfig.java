package com.redhat.cloud.notifications.connector.slack.config;
...
@ApplicationScoped
public class SlackConnectorConfig extends HttpConnectorConfig {

    private String toggleUseBetaTemplatesEnabled;

    @PostConstruct
    void slackConnectorPostConstruct() {
