...
public class OpenShift {
    ...
    public static final Map<TemplateDefinition, String> templatesMap = Map.ofEntries(
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, ADVISOR_APP_NAME, ADVISOR_NEW_RECOMMENDATION), ADVISOR_FOLDER_NAME + "newRecommendationInstantEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_MISSING_COST_MODEL), COST_MANAGEMENT_FOLDER_NAME + "MissingCostModelEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_COST_MODEL_CREATE), COST_MANAGEMENT_FOLDER_NAME + "CostModelCreateEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_COST_MODEL_UPDATE), COST_MANAGEMENT_FOLDER_NAME + "CostModelUpdateEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_COST_MODEL_REMOVE), COST_MANAGEMENT_FOLDER_NAME + "CostModelRemoveEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_CM_OPERATOR_STALE), COST_MANAGEMENT_FOLDER_NAME + "CmOperatorStaleEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_CM_OPERATOR_DATA_RECEIVED), COST_MANAGEMENT_FOLDER_NAME + "CmOperatorDataReceivedEmailTitle.txt"),
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, COST_MANAGEMENT_APP_NAME, COST_MANAGEMENT_CM_OPERATOR_DATA_PROCESSED), COST_MANAGEMENT_FOLDER_NAME + "CmOperatorDataProcessedEmailTitle.txt"),
