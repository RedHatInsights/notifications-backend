...
public class Console {
    ...
    public static final Map<TemplateDefinition, String> templatesMap = Map.ofEntries(
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_RH_NEW_ROLE_AVAILABLE, true), RBAC_FOLDER_NAME + "beta/systemRoleAvailableEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_RH_PLATFORM_DEFAULT_ROLE_UPDATED, true), RBAC_FOLDER_NAME + "beta/platformRoleUpdatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_RH_NON_PLATFORM_DEFAULT_ROLE_UPDATED, true), RBAC_FOLDER_NAME + "beta/nonPlatformRoleUpdatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_CUSTOM_ROLE_CREATED, true), RBAC_FOLDER_NAME + "beta/customRoleCreatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_CUSTOM_ROLE_UPDATED, true), RBAC_FOLDER_NAME + "beta/customRoleUpdatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_CUSTOM_ROLE_DELETED, true), RBAC_FOLDER_NAME + "beta/customRoleDeletedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_RH_NEW_ROLE_ADDED_TO_DEFAULT_ACCESS, true), RBAC_FOLDER_NAME + "beta/roleAddedToPlatformGroupEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_RH_ROLE_REMOVED_FROM_DEFAULT_ACCESS, true), RBAC_FOLDER_NAME + "beta/roleRemovedFromPlatformGroupEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_CUSTOM_DEFAULT_ACCESS_UPDATED, true), RBAC_FOLDER_NAME + "beta/customPlatformGroupUpdatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_GROUP_CREATED, true), RBAC_FOLDER_NAME + "beta/customGroupCreatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_GROUP_UPDATED, true), RBAC_FOLDER_NAME + "beta/customGroupUpdatedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_GROUP_DELETED, true), RBAC_FOLDER_NAME + "beta/customGroupDeletedEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_PLATFORM_DEFAULT_GROUP_TURNED_INTO_CUSTOM, true), RBAC_FOLDER_NAME + "beta/platformGroupToCustomEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_REQUEST_ACCESS, true), RBAC_FOLDER_NAME + "beta/requestAccessEmailBody.html"),
        ...
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, RBAC_APP_NAME, RBAC_RH_NEW_TAM_REQUEST_CREATED, true), RBAC_FOLDER_NAME + "beta/tamAccessRequestEmailBody.html"),
