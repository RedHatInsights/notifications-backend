...
public class DefaultTemplates {
    ...
    public static final Map<TemplateDefinition, String> templatesMap = Map.ofEntries(
        ...
        entry(new TemplateDefinition(GOOGLE_CHAT, null, null, null, true), "Default/beta/default.json"),
        ...
        entry(new TemplateDefinition(EMAIL_DAILY_DIGEST_BUNDLE_AGGREGATION_BODY, null, null, null, true), "Common/beta/insightsDailyEmailBodyV2.html"),
