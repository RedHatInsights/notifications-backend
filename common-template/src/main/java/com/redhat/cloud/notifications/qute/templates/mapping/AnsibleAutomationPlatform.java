...
public class AnsibleAutomationPlatform {
    ...
    public static final Map<TemplateDefinition, String> templatesMap = Map.ofEntries(
        ...
        entry(new TemplateDefinition(EMAIL_TITLE, BUNDLE_NAME, ANSIBLE_SERVICE_ON_AWS_APP_NAME, "notify-customer-provision-success"), ANSIBLE_SERVICE_ON_AWS_FOLDER_NAME + "notifyCustomerProvisionSuccessEmailTitle.txt"),
        entry(new TemplateDefinition(EMAIL_BODY, BUNDLE_NAME, ANSIBLE_SERVICE_ON_AWS_APP_NAME, "notify-customer-provision-success"), ANSIBLE_SERVICE_ON_AWS_FOLDER_NAME + "notifyCustomerProvisionSuccessEmailBody.html")
    );
}
