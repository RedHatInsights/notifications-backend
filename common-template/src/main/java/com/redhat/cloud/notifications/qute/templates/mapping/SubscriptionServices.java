...
public class SubscriptionServices {
    ...
    public static final Map<TemplateDefinition, String> templatesMap = Map.ofEntries(
        ...
        entry(new TemplateDefinition(GOOGLE_CHAT, BUNDLE_NAME, ERRATA_APP_NAME, ERRATA_NEW_SUBSCRIPTION_BUGFIX_ERRATA, true), ERRATA_FOLDER_NAME + "beta/newSubscriptionBugfixErrata.json"),
        ...
        entry(new TemplateDefinition(GOOGLE_CHAT, BUNDLE_NAME, ERRATA_APP_NAME, ERRATA_NEW_SUBSCRIPTION_SECURITY_ERRATA, true), ERRATA_FOLDER_NAME + "beta/newSubscriptionSecurityErrata.json"),
        ...
        entry(new TemplateDefinition(GOOGLE_CHAT, BUNDLE_NAME, ERRATA_APP_NAME, ERRATA_NEW_SUBSCRIPTION_ENHANCEMENT_ERRATA, true), ERRATA_FOLDER_NAME + "beta/newSubscriptionEnhancementErrata.json"),
