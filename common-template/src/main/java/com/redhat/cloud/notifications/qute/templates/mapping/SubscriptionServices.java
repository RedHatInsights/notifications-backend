...
public class SubscriptionServices {
    ...
    public static final Map<TemplateDefinition, String> templatesMap = Map.ofEntries(
        ...
        // Subscriptions Usage
        entry(new TemplateDefinition(DRAWER, BUNDLE_NAME, SUBSCRIPTIONS_USAGE_APP_NAME, SUBSCRIPTIONS_USAGE_EXCEEDED_UTILIZATION_THRESHOLD), SUBSCRIPTIONS_USAGE_FOLDER_NAME + "usageThresholdExceededBody.md"),
        entry(new TemplateDefinition(DRAWER, BUNDLE_NAME, SUBSCRIPTIONS_USAGE_APP_NAME, SUBSCRIPTIONS_USAGE_EXCEEDED_CUSTOM_UTILIZATION_THRESHOLD), SUBSCRIPTIONS_USAGE_FOLDER_NAME + "customUtilizationThresholdExceededBody.md"),
