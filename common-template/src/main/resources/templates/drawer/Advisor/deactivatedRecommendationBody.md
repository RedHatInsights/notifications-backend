...
{#else}
    1 recommendation has recently been deactivated by Red Hat Insights and is no longer affecting your systems. [Open Advisor]({environment.url}/insights/advisor/recommendations/{data.events[0].payload.rule_id}?from=notifications&integration=drawer)
{/if}
{/let}
