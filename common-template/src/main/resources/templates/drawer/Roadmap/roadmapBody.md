...
{#body}
{#let deprecationsCount=data.events[0].payload.deprecation.orEmpty.count.or(0) changesCount=data.events[0].payload.change.orEmpty.count.or(0) additionsCount=data.events[0].payload.addition.orEmpty.count.or(0)}
