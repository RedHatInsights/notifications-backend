...
class TestOcmTemplate {
    ...
    private static final String CLUSTER_MANAGER_DEFAULT_EVENT_URL = "http://localhost/openshift/details/s/2XqNHRdLNEAzshh7MkkOql6fx6I?from=notifications&integration=google_chat";
    ...
    String renderTemplate(final String eventType, final JsonObject message) {
        TemplateDefinition templateConfig = new TemplateDefinition(GOOGLE_CHAT, "openshift", "cluster-manager", eventType);
