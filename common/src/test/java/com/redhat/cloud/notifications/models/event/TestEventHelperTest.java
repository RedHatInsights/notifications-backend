...
public class TestEventHelperTest {
    ...
    public void createTestActionTest() {
        ...
        Assertions.assertEquals(TestEventConstants.TEST_ACTION_VERSION, testAction.getVersion(), "unexpected version in the test action");
        Assertions.assertEquals(TestEventConstants.TEST_ACTION_BUNDLE, testAction.getBundle(), "unexpected bundle in the test action");
        Assertions.assertEquals(TestEventConstants.TEST_ACTION_APPLICATION, testAction.getApplication(), "unexpected application in the test action");
        Assertions.assertEquals(TestEventConstants.TEST_ACTION_EVENT_TYPE, testAction.getEventType(), "unexpected event type in the test action");
