...
public class EmailAggregator {
    ...
    public Map<User, Map<String, Object>> getAggregated(UUID appId, EmailAggregationKey aggregationKey, SubscriptionType subscriptionType, LocalDateTime start, LocalDateTime end) {
        ...
        if (engineConfig.isAggregationBasedOnEventEnabled() && aggregationKey instanceof EventAggregationCriteria eventAggregationCriteria) {
    ...
    private Set<User> getRecipients(String orgId, Set<String> subscribers, Stream<ActionRecipientSettings> actionRecipientSettings, Set<Endpoint> endpoints) {
