...
public class EmailPendoResolver {
    ...
    public static final String OUTAGE_PENDO_MESSAGE = "Between Aug 22, 07:21 AM UTC and Aug 26, 12:47 PM UTC, the notifications email service experienced an outage. This email was delayed from that time period.";
