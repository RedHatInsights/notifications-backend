...
public class ErrataEmailPayloadAggregator extends AbstractEmailPayloadAggregator {
    ...
    protected static final String EVENT_TYPE_BUGFIX = "new-subscription-bugfix-errata";
    protected static final String EVENT_TYPE_ENHANCEMENT = "new-subscription-enhancement-errata";
    protected static final String EVENT_TYPE_SECURITY = "new-subscription-security-errata";
    ...
    void processEmailAggregation(EmailAggregation notification) {
        ...
        if (!errata.containsKey(BASE_URL_KEY) && context.containsKey(BASE_URL_KEY)) {
            context.put(BASE_URL_KEY, context.getString(BASE_URL_KEY));
        }
