...
public class ConnectorReceiver {
    ...
    public void processAsync(String payload) {
        try {
            ...
            drawerProcessor.manageConnectorDrawerReturnsIfNeeded(decodedPayload, historyId);
            ...
            endpointErrorFromConnectorHelper.manageEndpointDisablingIfNeeded(endpoint, payloadAsJson);
