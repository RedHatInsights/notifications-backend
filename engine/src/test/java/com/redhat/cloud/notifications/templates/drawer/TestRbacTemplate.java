    ...
    private void checkResult(String eventType, String result) {
        switch (eventType) {
            ...
            case CUSTOM_ROLE_CREATED:
                assertEquals("A custom role **[testRoleName](https://localhost/iam/user-access/roles/detail/d69ef18d-22d8-4b08-ac9b-096d13148407?from=notifications&integration=drawer)** has been created by testUser1.", result);
                break;
            case CUSTOM_ROLE_UPDATED:
                assertEquals("Custom role **[testRoleName](https://localhost/iam/user-access/roles/detail/d69ef18d-22d8-4b08-ac9b-096d13148407?from=notifications&integration=drawer)** has been updated by testUser1.", result);
                break;
            ...
            case CUSTOM_DEFAULT_ACCESS_UPDATED:
                ...
                break;
            case GROUP_CREATED:
                assertEquals("A custom group **[testRoleName](https://localhost/iam/user-access/groups/detail/d69ef18d-22d8-4b08-ac9b-096d13148407?from=notifications&integration=drawer)** has been created by testUser1.", result);
                break;
            case GROUP_UPDATED:
                assertEquals("Custom group has been updated by testUser1. [Open group details](https://localhost/iam/user-access/groups/detail/d69ef18d-22d8-4b08-ac9b-096d13148407?from=notifications&integration=drawer)", result);
                break;
            case GROUP_DELETED:
            ...
            case PLATFORM_DEFAULT_GROUP_TURNED_INTO_CUSTOM:
                assertEquals("Platform default group is modified by testUser1 and Red Hat will not be responsible for managing it from now on. [Open group details](https://localhost/iam/user-access/groups/detail/d69ef18d-22d8-4b08-ac9b-096d13148407?from=notifications&integration=drawer)", result);
                break;
            case REQUEST_ACCESS:
