    ...
    private void checkResult(String eventType, String result) {
        switch (eventType) {
            case RH_NEW_ROLE_AVAILABLE:
                assertEquals("Red Hat now provides a new role **[testRoleName](https://localhost/iam/user-access/roles/detail/d69ef18d-22d8-4b08-ac9b-096d13148407)**.", result);
                break;
            case RH_PLATFORM_DEFAULT_ROLE_UPDATED:
            case RH_NON_PLATFORM_DEFAULT_ROLE_UPDATED:
                assertEquals("Red Hat has updated the role **[testRoleName](https://localhost/iam/user-access/roles/detail/d69ef18d-22d8-4b08-ac9b-096d13148407)**.", result);
                break;
            case CUSTOM_ROLE_CREATED:
                assertEquals("A custom role **[testRoleName](https://localhost/iam/user-access/roles/detail/d69ef18d-22d8-4b08-ac9b-096d13148407)** has been created by testUser1.", result);
                break;
            case CUSTOM_ROLE_UPDATED:
                assertEquals("Custom role **[testRoleName](https://localhost/iam/user-access/roles/detail/d69ef18d-22d8-4b08-ac9b-096d13148407)** has been updated by testUser1.", result);
                break;
            ...
            case GROUP_CREATED:
                ...
                break;
            case GROUP_UPDATED:
                assertEquals("Custom group has been updated by testUser1. [Open group details](https://localhost/iam/user-access/groups/detail/d69ef18d-22d8-4b08-ac9b-096d13148407)", result);
                break;
            case GROUP_DELETED:
