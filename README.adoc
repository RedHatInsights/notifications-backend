...
This repo uses link:https://github.com/gwenneg/togi[togi] to turn AI friction into context-doc improvements. Participation is opt-in per developer — see link:adopt-togi.md[adopt-togi.md] for the setup commands.
