...
- **Renovate**: Configured via `renovate.jsonc` for automerge of Maven, npm, allow-listed GitHub Actions, Docker base image digests and Tekton pipeline reference updates.
