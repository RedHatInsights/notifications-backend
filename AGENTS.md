...
- **Renovate (MintMaker)**: Configured via `renovate.jsonc`. Automerges patch/minor Maven and npm bumps, base image digest/patch/minor bumps, allow-listed GitHub Actions, and Tekton pipeline updates; majors and `io.quarkus*` stay on manual review.
