...
- **Renovate (MintMaker)**: Configured via `renovate.jsonc` for Maven, npm, GitHub Actions, base image, and Tekton pipeline reference updates, with automerge scoped per ecosystem.
