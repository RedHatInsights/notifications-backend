...
- **Renovate**: Managed by MintMaker for Maven, npm, GitHub Actions, Dockerfile and Tekton pipeline dependency updates; `renovate.jsonc` holds this repo's overrides, including automerge rules.
