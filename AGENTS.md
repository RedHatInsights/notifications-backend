...
- **Renovate (MintMaker)**: Configured via `renovate.jsonc` for Maven, npm, GitHub Actions, Dockerfile and Tekton pipeline reference updates, with automerge for low-risk updates.
