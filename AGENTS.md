...
- **Renovate (MintMaker)**: Configured via `renovate.jsonc` for Tekton pipeline reference updates and Maven, npm, GitHub Actions, and base image updates, with automerge for the low-risk subset.
