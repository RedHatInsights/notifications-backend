...
- **Renovate (MintMaker)**: Configured via `renovate.jsonc` for Maven, npm, GitHub Actions, Tekton pipeline, and container base image updates, with automerge scoped per ecosystem.
