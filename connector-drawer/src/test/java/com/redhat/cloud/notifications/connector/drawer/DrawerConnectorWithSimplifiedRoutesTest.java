...
class DrawerConnectorWithSimplifiedRoutesTest extends CamelQuarkusTestSupport {
    ...
    void testFailureNotification() throws Exception {
        ...
        JsonObject jsonObject = testFailedNotification(drawerConnectorConfig.getRedeliveryMaxAttempts());
        JsonObject data = new JsonObject(jsonObject.getString("data"));
    ...
    protected JsonObject testFailedNotification(final int maxExpectedRedeliveries) throws Exception {
        ...
        //micrometerAssertionHelper.assertCounterIncrement(drawerConnectorConfig.getRedeliveryCounterName(), maxExpectedRedeliveries);
