...
public class ResourceHelpers {
    ...
    public void addEmailAggregation(String tenant, String bundle, String application, String policyId,
            String insightsId) {
    ...
    public Integer purgeOldAggregation(EmailAggregationKey key, LocalDateTime lastUsedTime) {
        ...
        final int result = session.createQuery(query).setParameter("accountId", key.getAccountId())
