...
public class TestHelpers {
    ...
    static EmailAggregation createEmailAggregation(String tenant, String bundle, String application, String policyId,
            String inventoryId) {
        ...
        emailActionMessage.setContext(Map.of("inventory_id", inventoryId, "system_check_in",
