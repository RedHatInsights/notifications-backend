package com.redhat.cloud.notifications.connector.microsoft.teams.config;
...
@ApplicationScoped
public class TeamsConnectorConfig extends HttpConnectorConfig {

    private String toggleUseBetaTemplatesEnabled;

    @PostConstruct
    void teamsConnectorPostConstruct() {
